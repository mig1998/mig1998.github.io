...
"<br><br> E este p,o,r,t,f,ó,l,i,o apre,sen,tará um ,pouco, mais, sobre, <br>os, projetos, que, desenvolvi, nesses, anos, de ,estudos";
...
for (let i = 0; i < arraysou.length; i++) {
    ...
    var myText = document.createElement('h4')
